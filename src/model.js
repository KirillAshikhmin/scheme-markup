...
const TEMPLATE_CATEGORIES = [
  ...
  // и выход канализации — не электрика, и в «Климате» или «Розетках» они
  // читались бы как электрика и красились бы её цветом.
  //
  // Цвет — тёмный морской. По ГОСТ 14202-69 вода на схемах зелёная, но чистый
  // зелёный занят выключателями, поэтому взят тёмный морской: до ближайшей из
  // семи прежних категорий (тёмная бирюза датчиков) 36,3, до зелени
  // выключателей 37,2 — обе дальше самой близкой пары среди прежних (29,0
  // у света с сетевым), и метка не теряется на заливке контуров помещений
  // (test/colors.test.js). Голубой и бирюзовый, как ни просятся к воде, не
  // проходят: между синим света, тёмной бирюзой датчиков и бледными заливками
  // комнат там уже не остаётся места.
  { key: "plumbing", name: strings.categories.plumbing, color: "#0A6E52", shape: "drop-dot" },
];
