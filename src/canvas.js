...
//
// Стрелки везут план в сторону стрелки — ту же, в какую его тащит рука:
// перетаскивание двигает план за курсором, и клавиша ведёт себя так же, иначе
// две привычки в одном холсте противоречат друг другу.
//
...
// Куда едет план по каждой стрелке.
