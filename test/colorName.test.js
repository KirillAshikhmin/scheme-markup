...
// называется вот этот цвет»: все тринадцать категорий шаблона, все 24 цвета
...
test("цвета категорий шаблона называются узнаваемо", () => {
  assert.deepEqual(
    ...
    [
      ...
      ["Не назначено", "#FF007F", "розовый"],
      // Два «зелёных», два «синих», два «пурпурных» и два «коричневых» подряд —
      // это не поломка имён, а сам справочник заказчика: он держит пять пар
